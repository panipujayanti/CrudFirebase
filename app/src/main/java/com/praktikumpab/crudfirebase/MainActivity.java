    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btCreateDB.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(MainActivity.this, DBCreateActivity.class));
            }
        });
        ...
        btViewDB.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // Code untuk melihat data
                startActivity(new Intent(MainActivity.this, DBReadActivity.class ));
            }
        });
    }
}
